...
# replace ls with exa (icons + nice formatting)
alias ls='eza --icons --group-directories-first --color=always' # ls
alias ll='eza -lh --icons --group-directories-first --color=always' # ll
alias la='eza -lah --icons --group-directories-first --color=always' # la
...
alias ls1='eza -1 --icons --group-directories-first --color=always'  # ls line by line
alias ldir='eza --icons --only-dirs --group-directories-first --color=always'  # only directories
alias ff='fastfetch'
alias pf='pfetch'
...
__conda_setup="$('/home/aditya/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
